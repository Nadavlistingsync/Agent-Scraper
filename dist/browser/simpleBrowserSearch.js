...
export class SimpleBrowserSearch {
    ...
    async initialize() {
        try {
            ...
            logError(error, { context: 'SimpleBrowserSearch.initialize' });
            throw error;
        }
    }
    ...
    async searchConstruction(states = []) {
        const sampleResults = [
            {
...
//# sourceMappingURL=simpleBrowserSearch.js.map